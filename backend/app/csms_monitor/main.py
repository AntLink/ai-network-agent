...
from app.csms_monitor.routers import scpi, system, gps, spectrum_db
...
app.include_router(spectrum_db.router, prefix=f"{settings.API_PREFIX}/spectrum-db", tags=["Spectrum DB"])
...
async def root():
    return {
        ...
        "endpoints": {
            ...
            "spectrum_db": f"{settings.API_PREFIX}/spectrum-db",
