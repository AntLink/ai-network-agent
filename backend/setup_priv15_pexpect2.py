...
def setup_priv15():
    # Use ssh.exe from Windows
    child = pexpect.popen_spawn.PopenSpawn(f'ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null {USER}@172.22.45.249', timeout=30)
