...
slow_send(s, "crypto ?", 2)
slow_send(s, "crypto key ?", 2)

# versi tanpa argumen -> biasanya minta ukuran
out = slow_send(s, "crypto key generate rsa", 4)
if "modulus" in out.lower() or "[512]" in out or "size" in out.lower():
    print("\n--- kirim ukuran 2048 ---")
    s.send(b"2048\r")
